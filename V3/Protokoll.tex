...
\label{rohdaten}
\end{figure}
Das Volumen $V$ in der Formel für $\kappa$ setzt sich zusammen aus dem Flaschenvolumen $V_F$, dem Volumen im Glasrohr $x_0A$ und dem Restvolumen $V_r$. Man erhält einen linearen Zusammenhang
