...
erho_cu = rho_cu*np.sqrt( em**2/(m5**2) + el**2/(l5**2) + 4*(ed5**2)/(d5**2))
rho_messing = 4*m6/(np.pi*d6**2*l6)
erho_messing = rho_messing*np.sqrt( em**2/(m6**2) + el**2/(l6**2) + 4*ed6**2/(d6**2))
rho_al = 4*m9/(np.pi*d9**2*l9)
erho_al = rho_al*np.sqrt( em**2/(m9**2) + el**2/(l9**2) + 4*(ed9**2)/(d9**2))
rho_stahl = 4*m11/(np.pi*d11**2*l11)
erho_stahl = rho_stahl*np.sqrt( em**2/(m11**2) + el**2/(l11**2) + 4*ed11**2/(d11**2))
...
eE5 = E5*np.sqrt(4*f_5[1]**2/(f_5[0]**2) + el**2/(l5**2) + em**2/(m5**2) + 4*ed5**2/(d5**2))
eE6 = E6*np.sqrt(4*f_6[1]**2/(f_6[0]**2) + el**2/(l6**2) + em**2/(m6**2) + 4*ed6**2/(d6**2))
eE9 = E9*np.sqrt(4*f_9[1]**2/(f_9[0]**2) + el**2/(l9**2) + em**2/(m9**2) + 4*ed9**2/(d9**2))
eE11 = E11*np.sqrt(4*f_11[1]**2/(f_11[0]**2) + el**2/(l11**2) + em**2/(m11**2) + 4*ed11**2/(d11**2))