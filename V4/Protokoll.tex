...
%\captionof{Messungen der Schwingungen mit verschiedenen Einstellungen des Potentiometers (v.l: $60\Omega$, $160\Omega$ und $186\Omega$). Man erkennt gut, wie durch das Erhöhen des Widerstandwertes die Schwingung abnimmt.}
%\label{pic:oszi}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
...
\newpage
\input{gekoppelteSchwingkreise.tex}
